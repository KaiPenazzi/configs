...
local function restart_waybaer_hyprpaper()
    hl.exec_cmd("pkill -x waybar || true")
    hl.exec_cmd("pkill -x hyprpaper || true")
    hl.exec_cmd("sleep 0.1")
    hl.exec_cmd("setsid waybar >/dev/null 2>&1 &")
    hl.exec_cmd("setsid hyprpaper >/dev/null 2>&1 &")
end
